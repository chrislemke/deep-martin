...
from bertviz.transformers_neuron_view import RobertaModel as VizModel
from bertviz.transformers_neuron_view import RobertaTokenizer as VizTokenizer
...
class BertVisualizer:
    def __init__(self, sentence1: str, sentence2: str, display_mode: str = "light"):
        ...
        self.model = RobertaModel.from_pretrained(
            "roberta-large", output_attentions=True
        )

        self.sentence1 = sentence1
        self.sentence2 = sentence2
        inputs = self.tokenizer.encode_plus(
            sentence1, sentence2, return_tensors="pt", add_special_tokens=True
        )
