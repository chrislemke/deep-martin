...
class Plotter:
    ...
    def plot_correlation(
        x_values: List[float], y_values: List[float], save_path: Optional[str] = None
    ):
    ...
    @staticmethod
    def plot_loss(
        values: List[float], save_path: Optional[str] = None, x_label: str = "Epoch"
    ):
    ...
    @staticmethod
    def plot_scatter(
        values, x: str, y: str, color: str, save_path: Optional[str] = None
    ):
